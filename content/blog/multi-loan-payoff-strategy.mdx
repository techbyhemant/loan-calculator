...
Run your own numbers below to see exactly how a part payment changes your [debt-free date](/). If you have [multiple loans](/calculators/multi-loan-planner), run the calculation for your highest-interest loan first to see the maximum impact.
