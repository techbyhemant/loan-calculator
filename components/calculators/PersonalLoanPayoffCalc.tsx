...
// Module-scope formatter — the schedule loop runs up to 600 iterations
// and the previous toLocaleDateString call constructed a fresh
// Intl.DateTimeFormat per iteration. Hoisting cuts that to one
// allocation total. Same reasoning as the homepage calculator.
...
function generateSchedule(params: {
  ...
  // Pre-compute the loop-invariant start position so we don't allocate
  // a new Date inside each iteration.
