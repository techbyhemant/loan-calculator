  ...
  return (
    <html lang="en-IN" suppressHydrationWarning>
      ...
      >
        ...
        {/* Microsoft Clarity — gated behind the same cookie consent the
            CookieConsent component manages. ClarityLoader subscribes to
            the consent change event and only renders the script tag once
