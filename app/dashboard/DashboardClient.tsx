...
type RouterLoans = inferRouterOutputs<AppRouter>["loans"]["getAll"];
...
export default function DashboardClient({
  ...
  initialLoans: RouterLoans;
}) {
  // Server already fetched the loans during render. We pass them as
  // initialData so React Query renders the dashboard with data on the
  // first paint — no skeleton, no waterfall. React Query revalidates in
  // the background per its staleTime (60s), so this stays fresh.
