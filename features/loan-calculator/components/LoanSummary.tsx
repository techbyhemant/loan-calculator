  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      <div className="flex flex-wrap gap-3">
        <div className="bg-card rounded-xl shadow-sm p-4 flex flex-col items-center min-w-[260px] flex-1">
          <div className="text-sm text-muted-foreground mb-1">Loan EMI</div>
